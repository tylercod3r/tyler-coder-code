    ...
    return(
        <section className="border-2 border-blue-400">
            <div /*className={styles.keywordItems}*/>
                ...
                <p /*className={KeywordFont.className}*/ key={keyword}>{keyword.toUpperCase()}</p>
                ))}
            </div>
            ...
            <div /*className={styles.subKeywordItems}*/>
                ...
                <p key={subKeyword} /*className={KeywordFont.className}*/>{subKeyword.toUpperCase()}</p>
                ))}
            </div>
            ...
            <a href={props.project.url} target="_blank" rel="noopener noreferrer">
                <Image src={imagePath} /*className={styles.projectImage}*/ width="270" height="230" alt={props.project.title}/>
            </a>

            <p /*className={CardHeaderFont.className}*/>
